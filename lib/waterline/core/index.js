...
var Core = module.exports = function(options) {
  ...
  this.defaults = _.mergeWith(COLLECTION_DEFAULTS, this.defaults);
...
Core._initialize = function(options) {
  ...
  var _validations = _.cloneWith(this._attributes);
  ...
  this.adapterDictionary = new Dictionary(_.cloneDeepWith(this.connections), this.connection);
